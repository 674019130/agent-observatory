...
<p align="center">
  <img src="docs/assets/interface-preview.png" width="960" alt="Agent Observatory 記憶 Inspector 介面預覽">
</p>

這個介面按原生 Mac 控制台來設計：左側是安靜的 source list，中間是高密度的
上下文卡片，右側是捲動時始終留在視口內的 inspector。緊湊 badge、路徑預覽、
遷移狀態和 Finder-first 的檔案動作，讓很大的 Claude Code / Codex 設定也能保持
可掃描、可理解。
